        ...
        <table border="1" cellspacing="0" cellpadding="0" width="80%" style="width:443.297px;border:1pt solid windowtext">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border:none;padding:5pt">
                        <div style="margin:0in 0in 0.0001pt;font-size:12pt;font-family:Times New Roman,serif"><a href="<?php echo 'mailto:' . $ord->second_email; ?>" target="_blank"><?php echo $ord->second_email; ?></a></div>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="border:none;background-color:lightgrey;padding:5pt">
                        ...
                        <div style="margin:0in 0in 0.0001pt;font-size:12pt;font-family:Times New Roman,serif">{{ $ord->wedWelReception == '1' ? "I will Attend" : "I will Not Attend" }}<u></u><u></u></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="border:none;padding:5pt">                                                                        
                        <div style="margin:0in 0in 0.0001pt;font-size:12pt;font-family:Times New Roman,serif">{{ $ord->thursdayBreakfast == '1' ? "I will Attend" : "I will Not Attend" }}<u></u><u></u></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="border:none;background-color:lightgrey;padding:5pt">
                        <div style="margin:0in 0in 0.0001pt;font-size:12pt;font-family:Times New Roman,serif">{{ $ord->thursdayLuncheon == '1' ? "I will Attend" : "I will Not Attend" }}<u></u><u></u></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="border:none;padding:5pt">                                                        
                        <div style="margin:0in 0in 0.0001pt;font-size:12pt;font-family:Times New Roman,serif">{{ $ord->thursdayDinner == '1' ? "I will Attend" : "I will Not Attend" }}<u></u><u></u></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="border:none;background-color:lightgrey;padding:5pt"> 
                        <div style="margin:0in 0in 0.0001pt;font-size:12pt;font-family:Times New Roman,serif">{{ $ord->spouseDinnerTicket == '1' ? "Yes" : "No" }}<u></u><u></u></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="border:none;background-color:lightgrey;padding:5pt">
                        <div style="margin:0in 0in 0.0001pt;font-size:12pt;font-family:Times New Roman,serif">{{ $ord->fridayBreakfast == '1' ? "I will Attend" : "I will Not Attend" }}<u></u><u></u></div>
                    </td>
                </tr>
