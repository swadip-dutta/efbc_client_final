...
@section('title','Add Registered Attendee')
@section('attend')
active
@endsection
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-10">
                        ...
                        <div class="form-group row">
                            ...
                            <p>Conference Registration is $450 by March 4, 2022; $575 from March 5 to April 30, 2022;
                                $675 thereafter.</p>
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <div class="card" style="padding: 30px;">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                <h4>Payment Information </h4><br>
                                                <p>Conference Registration is $450 by March 4, 2022; $575 from March 5 to April 30, 2022; $675 thereafter.</p>
                                                    <label style="break-before: page; margin-left: -8px;" class="col-form-label col-md-4">Amount to be Paid</label>
                                                    
                                                        <div class="col-md-8">
                                                            <div class="form-group control-group">
                                                                <input name="payment_amount" placeholder="Please type the Amount" class="form-control" type="number" required="">
                                                            </div>
                                                        </div>
                                                </div>
                                                <div class="text-center">
                                                    <!-- <input type="hidden" name="payment_status" id="payment_status" value="offline"> -->
                                                    <button type="submit" style="cursor:pointer" class="btn btn-primary">Submit <i class="ml-2 fa fa-paper-plane"></i></button>
                                                </div>
                                            </div>
