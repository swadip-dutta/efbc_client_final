        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left"><i class="fa fa-arrow-circle-o-left mr-3"></i>Messaging Group</h4>
                    <ol class="breadcrumb float-right">
                        <li class="breadcrumb-item"><a href="{{ url('/messaging_view') }}"><i class="mdi mdi-account-plus mr-2"></i>Messaging List</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ url('/messaging_view') }}">Back</a></li>
                    </ol>
        ...
        <div class="row row-sm mg-t-20">
            <div class="col-lg-10 offset-1">
              <div class="card pd-20 pd-sm-40 form-layout form-layout-4" style="padding: x;">
                <center><h5 class="">Add Messaging Group</h5></center>
                  <form action="{{ route('post_group') }}" method="POST">
                    @csrf
                    <div class="row mg-t-20" style="margin: 10px auto;">
                      <label class="col-sm-4 form-control-label">Select Sub Category Name: <span class="tx-danger">*</span></label>
                    ...
                    <div class="row mg-t-20" style="margin: 10px auto;">
                      <label class="col-sm-4 form-control-label">Select Category Name: <span class="tx-danger">*</span></label>
                      <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    ...
                    <div class="form-layout-footer mg-t-10 text-center">
