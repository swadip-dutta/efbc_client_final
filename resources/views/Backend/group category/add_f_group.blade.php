        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left"><i class="fa fa-arrow-circle-o-left mr-3"></i>Fishing Group</h4>
        ...
        <div class="row row-sm mg-t-20">
            <div class="col-lg-10 offset-1">
              <div class="card pd-20 pd-sm-40 form-layout form-layout-4" style="padding: x;">
                <center><h5 class="">Add Fishing Group</h5></center>
