        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title float-left"><i class="fa fa-arrow-circle-o-left mr-3"></i>Golf Group</h4>
                    <ol class="breadcrumb float-right">
                        <li class="breadcrumb-item"><a href="{{ url('/golf_view') }}"><i class="mdi mdi-account-plus mr-2"></i>Group List</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ url('/golf_view') }}">Back</a></li>
                    </ol>
        ...
        <div class="row row-sm mg-t-20">
            <div class="col-lg-10 offset-1">
              <div class="card pd-20 pd-sm-40 form-layout form-layout-4" style="padding: x;">
                <center><h5 class="">Add Golf Group</h5></center>
                <form action="{{ route('post_group') }}" method="POST">
                  ...
                  <div class="form-layout-footer mg-t-20 text-center">
